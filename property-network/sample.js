...
async function get_greg() {
    ...
    const mspId = "gda"
    const keystorePath = path.join(__dirname, "keystore_advocate")
  //  const gregClient;
  //  const channel;
  //  console.log(fcw)
    ...
    const privateKeyPath = path.join(__dirname, "advocate_crypt/private")
    const publicKeyPath = path.join(__dirname, "advocate/public.pem")
